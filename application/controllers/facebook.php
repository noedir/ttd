...
class Facebook extends CI_Controller {
	...
	$this->load->helper('url');
        ...
        $this->appid = FACEBOOK_ID;
        $this->apisecret = FACEBOOK_SECRET;
	...
	$this->session->set_userdata('return',$this->input->get('inv'));
        ...
        $callback = 'http://'.CAMINHO_SITE.'/auth/token_facebook'; //base_url().'auth/token_facebook';
    ...
    public function confirm(){
        ...
        $redirect = 'http://'.CAMINHO_SITE.'/auth/token_facebook';
