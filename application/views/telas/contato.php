...
<div id="container">
	...
	<div class="baseNovoCount">
		...
		<p><input type="text" size="45" name="nome_contato" placeholder="Digite seu nome"><?php echo $avn; ?></p>
	    </div>
	    <div class="formNovoCount">
		<p><input type="text" size="45" name="email_contato" placeholder="Digite seu email"><?php echo $ave; ?></p>
	    </div>
	    <div class="formNovoCount">
		<p><input type="text" size="45" name="assunto_contato" placeholder="Digite o assunto"><?php echo $ava; ?></p>
	    </div>
	    <div class="formNovoCount">
		<p><textarea rows="5" cols="41" name="mensagem_contato" placeholder="Descreva sua mensagem"></textarea><?php echo $avm; ?></p>
	    </div>
	    <div class="formNovoCount">
